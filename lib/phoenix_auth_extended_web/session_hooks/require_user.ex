defmodule PhoenixAuthExtendedWeb.SessionHooks.RequireUser do
  @moduledoc """
  ...
  This hook should follow `PhoenixAuthExtendedWeb.SessionHooks.AssignUser` in a `Phoenix.LiveView.Router.live_session/3`.
