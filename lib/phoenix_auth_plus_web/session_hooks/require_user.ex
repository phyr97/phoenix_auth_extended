defmodule PhoenixAuthPlusWeb.SessionHooks.RequireUser do
  @moduledoc """
  ...
  This hook should follow `PhoenixAuthPlusWeb.SessionHooks.AssignUser` in a `Phoenix.LiveView.Router.live_session/3`.
