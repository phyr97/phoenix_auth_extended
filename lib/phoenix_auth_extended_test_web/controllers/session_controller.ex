defmodule PhoenixAuthExtendedTestWeb.SessionController do
  use PhoenixAuthExtendedTestWeb, :controller

  alias PhoenixAuthExtendedTest.Identity.User
  alias PhoenixAuthExtendedTest.Identity
  alias PhoenixAuthExtendedTestWeb.Auth
