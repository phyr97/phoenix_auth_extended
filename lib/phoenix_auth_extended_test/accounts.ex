defmodule PhoenixAuthExtendedTest.Accounts do
  @moduledoc """
  ...
  alias PhoenixAuthExtendedTest.Accounts.{User, UserToken, UserNotifier}
  alias PhoenixAuthExtendedTest.Repo
  alias PhoenixAuthExtendedTest.Validation
  ...
  Uses passkey_changeset if keys are present, Uses oauth_changeset if provider is present, otherwise basic_changeset.
