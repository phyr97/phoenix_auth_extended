defmodule PhoenixAuthExtendedTest.Accounts.User do
  use Ecto.Schema
  import Ecto.Changeset
  import PhoenixAuthExtendedTest.Validation
  ...
  schema "users" do
    ...
    has_many :keys, PhoenixAuthExtendedTest.Accounts.UserKey, preload_order: [desc: :last_used_at]

    has_many :tokens, PhoenixAuthExtendedTest.Accounts.UserToken,
