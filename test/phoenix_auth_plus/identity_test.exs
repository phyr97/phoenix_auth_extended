defmodule PhoenixAuthPlus.IdentityTest do
  @moduledoc false
  use PhoenixAuthPlus.DataCase, async: true
  alias PhoenixAuthPlus.IdentityFixtures
  alias PhoenixAuthPlus.Identity
  alias PhoenixAuthPlus.Identity.User
  alias PhoenixAuthPlus.Identity.UserKey
  alias PhoenixAuthPlus.Identity.UserToken
